...
$(document).ready(function() {
	var sizeBrand1 = $('#brand1 .catalog-page__list .catalog-page__card').size();
	console.log(sizeBrand1);
	if (sizeBrand1 == 0) {
		$('#brand1').css('display', 'none');
	}
	var sizeBrand1 = $('#brand2 .catalog-page__list .catalog-page__card').size();
	console.log(sizeBrand1);
	if (sizeBrand1 == 0) {
